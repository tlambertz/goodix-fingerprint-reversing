-- based on  https://github.com/JJJollyjim/wireshark-goodix/blob/master/goodix_message.lua
...
commands = {
   ...
   [0xA] = {
      ...
      [2] = {
         name = "McuEraseApp ? not actually seen tho",
         dissect_command = function(tree, buf)  end,
         dissect_reply = function(tree, buf)  end,
      },
      [3] = {
...
usb_table:add(0xffff, goodixpack)